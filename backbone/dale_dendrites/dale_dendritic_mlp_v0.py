...
from backbone.dendrites.utils import KWinners, rezero_weights
...
class DaleDendriticMLP(nn.Module):
    ...
    def __init__(
        ...
        for out_size in output_size:
            ...
            output_linear = nn.Linear(input_size, out_size)
            # if weight_init == "modified":
            #     self._init_sparse_weights(
...
# model.init_weights()
#
# input = torch.randn(128, 784)
# context = torch.randn(128, 784)
#
# model(input, context)
