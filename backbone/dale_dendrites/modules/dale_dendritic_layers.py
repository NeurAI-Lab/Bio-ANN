...
from backbone.dale_dendrites.modules.update_rules import DaleDendrites_cSGD_UpdatePolicy, HebbianUpdate
...
# Without Shunt
# =============================================================================
class DaleDendriticLayerBase(EiDense, metaclass=abc.ABCMeta):
    """
    ...
    def __init__(
            ...
            dendrite_sparsity, dendrite_bias=None, nonlinearity=None,
            weight_init_gain=None, i_iid_i=False, parent_idx=None,
    ):
        """
        ...
        self.weight_init_policy = EiDense_MultipleInt_LayerNorm_WeightInitPolicy(inhib_iid_init=i_iid_i)
...
class DaleAbsoluteMaxGatingDendriticLayer(DaleDendriticLayerBase):
    """
...
# With Shunt
# =============================================================================
class DaleDendriticLayerBaseWithShunt(EiDenseWithShunt, metaclass=abc.ABCMeta):
    """
    Base class for all Dendritic Layer modules.
    ...
    def __init__(
        ...
        self.parent_index = parent_idx
        self.weight_init_policy = EiDenseWithShunt_MultipleInt_LayerNorm_WeightInitPolicy(inhib_iid_init=i_iid_i)
        # self.init_weights()
...
class DaleAbsoluteMaxGatingDendriticLayerWithShunt(DaleDendriticLayerBaseWithShunt):
    """
    This layer is similar to `GatingDendriticLayer`, but selects dendrite activations
    based on absolute max activation values instead of just max activation values. For
    example, if choosing between activations -7.4, and 6.5 for a particular unit, -7.4
...
model = DaleAbsoluteMaxGatingDendriticLayer(
    n_input=100,
    layer_params=(500, 50),
    num_segments=10,
    dim_context=100,
