...
class GCILGCIFAR100(ContinualDataset):
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        super(GCILGCIFAR100, self).__init__(args)
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), GCILGCIFAR100.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet18(GCILGCIFAR100.N_CLASSES)
