...
class PermutedMNISTN(ContinualDataset):
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        """
        super(PermutedMNISTN, self).__init__(args)
        np.random.seed(args.mnist_seed)
        PermutedMNISTN.N_TASKS = args.num_tasks
        self.permutations = [Permutation() for _ in range(PermutedMNISTN.N_TASKS)]
        self.task_id = 0
    ...
    @staticmethod
    def get_backbone():
        return MNISTMLP(28 * 28, PermutedMNISTN.N_CLASSES_PER_TASK)
